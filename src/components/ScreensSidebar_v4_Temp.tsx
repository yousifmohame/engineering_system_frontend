...
import { 
  ...
  Rocket, Monitor, Hash, Folders, Layers, Calendar, HardHat, FileSignature,
  MapPin, Map, DollarSign, Mail, Megaphone, Download
} from 'lucide-react';
...
const SCREEN_SECTIONS: Record<SectionType, {
  ...
  'system-management': {
    ...
    screenIds: [
      ...
      'requirements-management', 'exceptions-special-requests', // ✅ شاشة 935 - استثناءات وطلبات خاصة
      'commitments-declarations', 'commitments-declarations-settings', 'document-types',
    ...
    >
      ...
      >
        ...
        <div className="mt-3 mb-2">
          <button
            onClick={() => onScreenChange('homepage')}
      ...
      <ScrollArea 
        className="h-full" 
        style={{ 
          maxHeight: 'calc(100vh - 240px)', // تقليل الارتفاع لاستيعاب زر الرئيس��ة
          '--scrollbar-width': '8px',
